...
repl_0202AB68:
	...
	ldrsb r0, [r0]					@ Load value   of NEXT_LEVEL_ID in r0
	ldr r1, =SUBLEVEL_LEVEL_TABLE	@ Load address of SUBLEVEL_LEVEL_TABLE in r1
	ldrsb r0, [r1, r0]				@ Load ACT_SELECTOR_ID of NEXT_LEVEL_ID in r0
	...
	ldrsb r0, [r0]					@ Load value of LEVEL_ID in r0
	ldrsb r0, [r1, r0]				@ Load ACT_SELECTOR_ID of LEVEL_ID in r0
	...
	ldrsb r1, [r1]					@ Load   value of LEVEL_ID in r1
